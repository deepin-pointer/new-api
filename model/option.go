...
func InitOptionMap() {
	...
	common.OptionMap["RetryTimesOnZeroOutput"] = strconv.Itoa(common.RetryTimesOnZeroOutput)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RetryTimesOnZeroOutput":
		common.RetryTimesOnZeroOutput, _ = strconv.Atoi(value)
